...
$section_style   = $bg_fixed . esc_attr($bg_color . $bg_image) . ';' . 'padding:' . esc_attr($atts['section_padding']) . ';' . 'margin:' . esc_attr($atts['section_margin']);
$container_class = ( isset( $atts['is_fullwidth'] ) && $atts['is_fullwidth'] ) ? 'fw-container-fluid' : 'fw-container';
?>
<section class="fw-main-row <?php echo esc_attr($section_extra_classes) ?>" style="<?php echo esc_attr($section_style); ?> " <?php echo esc_attr($bg_video_data_attr); ?>>
